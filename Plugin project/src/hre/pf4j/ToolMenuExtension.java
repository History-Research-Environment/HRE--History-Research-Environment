...
@Extension(ordinal = 2)
public class ToolMenuExtension implements ActionListener, ToolMenuExtensionPoint {
 ...
 */
	public void setNationalLanguage(String nls) {
		...
		System.out.println("  Plugin setting tools national language: " + nationalLanguage);
	}
 ...
 */
	...
	public void buildMenu(JMenu researchItem) {
        JMenu menu = new JMenu("Tool Plugin ++");
        plugInMenuItemA = new JMenuItem("Tool A");
        menu.add(plugInMenuItemA);
        plugInMenuItemA.addActionListener(this);
        plugInMenuItemB = new JMenuItem("Tool B");
