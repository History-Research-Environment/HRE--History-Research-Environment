...
@Extension(ordinal = 2)
public class ViewpointMenuExtension implements ActionListener, ViewpointMenuExtensionPoint {
 ...
 */
	public void setNationalLanguage(String nls) {
		...
		System.out.println("  Plugin setting viwpoint national language: " + nationalLanguage);
	}
 ...
 */
	...
	public void buildMenu(JMenu researchItem) {
        JMenu menu = new JMenu("Viewpoint Plugin ++");
        plugInMenuItemA = new JMenuItem("Viewpoint A");
        menu.add(plugInMenuItemA);
        plugInMenuItemA.addActionListener(this);
        plugInMenuItemB = new JMenuItem("Viewpoint B");
