 ...
 * @version Build 0.04.3225.0624
 */
public class HGlobal {
	public static String buildNo = "0.04.3225.0624";		// Set Build number as V.vv.BBYY.MMDD //$NON-NLS-1$
	public static String releaseDate = "24 June 2025";		// and release date to match //$NON-NLS-1$
