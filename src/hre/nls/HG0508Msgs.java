...
public class HG0508Msgs extends NLS {
	private static String BUNDLE_NAME = "hre.nls.HG0508-en"; //$NON-NLS-1$
	...
	public HG0508Msgs(String guiLanguage) {
		// set the Bundle Name to the requested language
		BUNDLE_NAME = "hre.nls.HG0508-" + guiLanguage;  //$NON-NLS-1$
		// initialize resource bundle
		NLS.initializeMessages(BUNDLE_NAME, HG0508Msgs.class);			
	}
}