...
public class HG0506Msgs extends NLS {
	private static String BUNDLE_NAME = "hre.nls.HG0506-en"; //$NON-NLS-1$
	...
	public HG0506Msgs(String guiLanguage) {
		...
		BUNDLE_NAME = "hre.nls.HG0506-" + guiLanguage;  //$NON-NLS-1$
		// initialize resource bundle
		NLS.initializeMessages(BUNDLE_NAME, HG0506Msgs.class);
	}
}
