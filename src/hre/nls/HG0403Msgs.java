...
public class HG0403Msgs extends NLS {
	private static String BUNDLE_NAME = "hre.nls.HG0403-en"; //$NON-NLS-1$
	...
	public HG0403Msgs(String guiLanguage) {
		// set the Bundle Name to the requested language
		BUNDLE_NAME = "hre.nls.HG0403-" + guiLanguage;  //$NON-NLS-1$
		// initialize resource bundle
		NLS.initializeMessages(BUNDLE_NAME, HG0403Msgs.class);			
	}
}