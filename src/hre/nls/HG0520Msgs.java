...
public class HG0520Msgs extends NLS {
	private static String BUNDLE_NAME = "hre.nls.HG0520-en"; //$NON-NLS-1$
	...
	public HG0520Msgs(String guiLanguage) {
		// set the Bundle Name to the requested language
		BUNDLE_NAME = "hre.nls.HG0520-" + guiLanguage;  //$NON-NLS-1$
		// initialize resource bundle
		NLS.initializeMessages(BUNDLE_NAME, HG0520Msgs.class);
	}
}
