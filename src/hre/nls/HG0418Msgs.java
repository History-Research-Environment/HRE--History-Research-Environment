...
public class HG0418Msgs extends NLS {
	private static String BUNDLE_NAME = "hre.nls.HG0418-en"; //$NON-NLS-1$
	...
	public HG0418Msgs(String guiLanguage) {
		// set the Bundle Name to the requested language
		BUNDLE_NAME = "hre.nls.HG0418-" + guiLanguage;  //$NON-NLS-1$
		// initialize resource bundle
		NLS.initializeMessages(BUNDLE_NAME, HG0418Msgs.class);			
	}
}
