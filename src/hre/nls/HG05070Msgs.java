...
public class HG05070Msgs extends NLS {
	private static String BUNDLE_NAME = "hre.nls.HG05070-en"; //$NON-NLS-1$
	...
	public HG05070Msgs(String guiLanguage) {
		...
		NLS.initializeMessages(BUNDLE_NAME, HG05070Msgs.class);
	}
}