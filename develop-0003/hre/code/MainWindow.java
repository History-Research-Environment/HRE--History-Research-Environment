...
public class MainWindow {
	...
	protected void createContents() {
		...
		/**
		 * Setup all menus as per '04.01 GUI_UserInterface 2018-12-15' specification
		 */
		...
		mntmCopyAs.setText("Copy Project As");
		...
		menuItem_8.setText("Select");
		
		MenuItem menuItem_9 = new MenuItem(menu_5, SWT.NONE);
		menuItem_9.setText("Link to Flag");
		...
		MenuItem mntmAdd_3 = new MenuItem(menu_8, SWT.CASCADE);
		mntmAdd_3.setText("Manage Locations...");
		
		Menu menu_21 = new Menu(mntmAdd_3);
		mntmAdd_3.setMenu(menu_21);
		
		MenuItem mntmAdd_4 = new MenuItem(menu_21, SWT.NONE);
		mntmAdd_4.setText("Add");
		...
		MenuItem mntmManageLocationName = new MenuItem(menu_8, SWT.CASCADE);
		mntmManageLocationName.setText("Manage Location Name Styles...");
		
		Menu menu_34 = new Menu(mntmManageLocationName);
		mntmManageLocationName.setMenu(menu_34);
		
		MenuItem mntmAdd_5 = new MenuItem(menu_34, SWT.NONE);
		mntmAdd_5.setText("Add");
		
		MenuItem mntmDelete_6 = new MenuItem(menu_34, SWT.NONE);
		mntmDelete_6.setText("Delete");
		
		MenuItem mntmEdit_5 = new MenuItem(menu_34, SWT.NONE);
		mntmEdit_5.setText("Edit");
		...
		MenuItem mntmRecentlyUsed = new MenuItem(menu_19, SWT.NONE);
		...
		mntmRepositories_1.setText("Repositories...");
		...
		MenuItem mntmLogging = new MenuItem(menu_11, SWT.NONE);
		...
		mntmAdmin.setText("Persons");
		
		MenuItem mntmProject_1 = new MenuItem(menu_13, SWT.NONE);
		mntmProject_1.setText("Viewpoints");
		
		MenuItem mntmProjects = new MenuItem(menu_13, SWT.NONE);
		mntmProjects.setText("Projects");
		
		MenuItem mntmLocation_1 = new MenuItem(menu_13, SWT.NONE);
		mntmLocation_1.setText("Locations");
		...
		mntmHistoricalDates_1.setText("Historical Dates");
		...
		MenuItem mntmImport = new MenuItem(menu_12, SWT.CASCADE);
		mntmImport.setText("Import...");
		
		Menu menu_35 = new Menu(mntmImport);
		mntmImport.setMenu(menu_35);
		
		MenuItem mntmFromTmg = new MenuItem(menu_35, SWT.NONE);
		mntmFromTmg.setText("From TMG");
		
		MenuItem mntmExport = new MenuItem(menu_12, SWT.CASCADE);
		mntmExport.setText("Export...");
		
		Menu menu_36 = new Menu(mntmExport);
		mntmExport.setMenu(menu_36);
		
		MenuItem mntmAdministration = new MenuItem(menu_12, SWT.CASCADE);
		mntmAdministration.setText("Administration...");
		
		Menu menu_37 = new Menu(mntmAdministration);
		mntmAdministration.setMenu(menu_37);
		
		MenuItem mntmEditAuxFiles = new MenuItem(menu_37, SWT.NONE);
		mntmEditAuxFiles.setText("Edit AUX files");
		
		MenuItem mntmUpdateSchema = new MenuItem(menu_37, SWT.NONE);
		mntmUpdateSchema.setText("Update Schema");
		
		MenuItem mntmEditUserRights = new MenuItem(menu_37, SWT.NONE);
		mntmEditUserRights.setText("Edit User Rights");
		 ...
		 */
		//
		//  Bug - when splash closed, MainWindow may not get focus again 
		//
		HelpAbout splashscreen=new HelpAbout();  
		splashscreen.setLocationRelativeTo(null);
		splashscreen.setVisible(true);
